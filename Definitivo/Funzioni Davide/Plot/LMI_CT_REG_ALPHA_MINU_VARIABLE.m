...
<<<<<<< HEAD:Definitivo/Funzioni Davide/Plot/LMI_CT_REG_ALPHA_MINU_VARIABLE.m
theta=pi/6;
=======
theta=pi/4;
%alpha=0.3;
alpha=2.2;
>>>>>>> 83ab94513f114afbcb6902968e4c820fd939610d:Definitivo/Funzioni Davide/LMI_CT_REG_ALPHA_MINU.asv
kL=sdpvar(1,1);
kY=sdpvar(1,1);
