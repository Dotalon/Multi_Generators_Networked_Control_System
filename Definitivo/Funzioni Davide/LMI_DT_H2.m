function [K2,rho2,feas2]=LMI_CT_H2(F,G,H,N,ContStruc)
...
LMIconstr=[P*F'+F*P+Gtot*L+L'*Gtot'+Gw*Gw'<=-1e-2*eye(ntot)]+[P>=1e-2*eye(ntot)]+[[S            Hh*P+Nh*L;  L'*Nh'+P*Hh'  P]>=1e-2*eye(ntot+mtot*5)];
