function [K2,rho2,feas2]=LMI_DT_EIG_CIRCLE_VARIABLE(F,G,H,N,ContStruc, alpha, r)
...
LMIconstr=[[(r^2-alpha^2)*P-F*P*F'-F*L'*Gtot'-Gtot*L*F'-alpha*(P*F'+F*P+L'*Gtot'+Gtot*L)     Gtot*L;
